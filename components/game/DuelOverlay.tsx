  ...
  return (
    <>
      <style jsx>{`
        ...
        .dim { animation: dimIn 0.24s ease forwards; }
        .duel-card-left-win { animation: cardLeftWin 3s cubic-bezier(0.22, 0.9, 0.22, 1) forwards; }
        .duel-card-left-lose { animation: cardLeftLose 3s cubic-bezier(0.22, 0.9, 0.22, 1) forwards; }
        .duel-card-left-pass { animation: cardLeftPass 3s cubic-bezier(0.22, 0.9, 0.22, 1) forwards; }
        .duel-card-right-win { animation: cardRightWin 3s cubic-bezier(0.22, 0.9, 0.22, 1) forwards; }
        .duel-card-right-lose { animation: cardRightLose 3s cubic-bezier(0.22, 0.9, 0.22, 1) forwards; }
        .duel-card-right-pass { animation: cardRightPass 3s cubic-bezier(0.22, 0.9, 0.22, 1) forwards; }
        .caption { animation: captionShow 3s cubic-bezier(0.22, 0.9, 0.22, 1) forwards; }
      `}</style>
    ...
    >
      ...
      <div className="mb-3 flex flex-wrap gap-1.5">
        {card.tags.slice(0, 4).map((tag) => (
          <span key={`${card.id}-${tag}`} className="border border-white/10 bg-black/30 px-2 py-1 text-[10px] font-bold text-zinc-200 sm:text-[11px]">
            {tag}
          </span>
        ))}
      </div>
