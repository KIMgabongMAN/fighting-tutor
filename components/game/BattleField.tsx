  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-zinc-700 bg-gradient-to-b from-zinc-900 via-zinc-950 to-black shadow-2xl">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/battlefield/grid-room-bg.png')",
        }}
      />

      <div className="relative z-10 flex items-center justify-between border-b border-zinc-800 bg-black/40 px-4 py-2 sm:px-6 sm:py-3">
      ...
      <div className="relative z-10 min-h-[420px] px-4 pb-20 pt-20 sm:min-h-[520px] sm:px-8 sm:pb-24 sm:pt-20">
          ...
          >
            {Array.from({ length: GRID_COLS * 4 }, (_, index) => {
              ...
              return (
                ...
                >
                  <div className="absolute inset-0 flex items-center justify-center text-[10px] font-black text-zinc-200/80 sm:text-xs">
        ...
        <div className="pointer-events-none absolute bottom-[48px] left-4 right-4 z-20 sm:bottom-[60px] sm:left-8 sm:right-8">
          <div className="relative h-[260px] sm:h-[320px]">
            <div
              className="absolute w-[90px] -translate-x-1/2 transition-all duration-300 sm:w-[128px]"
              style={{
                left: playerLeft,
            ...
            >
              <div className="h-full w-full rounded-sm border border-red-500/40 bg-red-500/18 shadow-[0_0_22px_rgba(239,68,68,0.14)]" />
            </div>
            ...
            >
              <div className="h-full w-full rounded-sm border border-amber-400/40 bg-amber-400/16 shadow-[0_0_22px_rgba(251,191,36,0.12)]" />
            </div>
          </div>
        </div>
