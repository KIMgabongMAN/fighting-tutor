...
export function BattleField({
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-zinc-700 bg-gradient-to-b from-zinc-900 via-zinc-950 to-black shadow-2xl">
      ...
      <div className="relative z-10 min-h-[420px] px-4 pb-28 pt-24 sm:min-h-[620px] sm:px-10 sm:pb-32 sm:pt-28">
        ...
        <div className="pointer-events-none absolute bottom-[150px] left-0 right-0 z-10 h-[220px] sm:bottom-[168px] sm:h-[320px]">
          <div
