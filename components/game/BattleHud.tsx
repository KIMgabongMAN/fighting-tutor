  ...
  return (
    <>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-[1fr_auto_1fr] sm:items-center">
          <div className="min-w-0">
            <div className="mb-2 flex items-center gap-2 sm:gap-3">
              <div className="border border-red-500/40 bg-red-950 px-2 py-1 text-[10px] font-black tracking-[0.2em] text-red-300 sm:text-xs">
                PLAYER
              </div>
          ...
          <div className="flex flex-row justify-center gap-3 sm:flex-col sm:items-center sm:px-3">
            ...
            <div className="border border-zinc-600 bg-zinc-900 px-4 py-1.5 text-2xl font-black shadow-lg sm:px-5 sm:py-2 sm:text-3xl">
              {round}
            </div>
            <div className="border border-zinc-700 bg-black px-3 py-1 text-xl font-black text-zinc-100 sm:mt-2 sm:px-4 sm:py-1 sm:text-2xl">
              99
            </div>
          </div>
          ...
          <div className="min-w-0">
            <div className="mb-2 flex items-center justify-end gap-2 sm:gap-3">
              ...
              <div className="border border-yellow-500/40 bg-yellow-950 px-2 py-1 text-[10px] font-black tracking-[0.2em] text-yellow-200 sm:text-xs">
                ENEMY
              </div>
            </div>
      ...
      <div className="grid grid-cols-2 gap-2 px-3 pt-3 sm:grid-cols-6 sm:gap-3 sm:px-4 sm:pt-4">
        ...
        <div className="border border-zinc-700 bg-zinc-900 px-3 py-2 sm:px-4 sm:py-3">
          <div className="mb-1 text-[10px] tracking-[0.2em] text-zinc-500 sm:text-xs">내 버스트</div>
          <div className="text-sm font-black sm:text-lg">{playerBurstUsed ? "사용 완료" : "사용 가능"}</div>
        </div>
